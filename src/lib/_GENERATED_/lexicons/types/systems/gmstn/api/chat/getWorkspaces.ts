...
const _mainSchema = /*#__PURE__*/ v.query(
  "systems.gmstn.api.chat.getWorkspaces",
  {
...
const _workspaceSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("systems.gmstn.api.chat.getWorkspaces#workspace"),
  ),
...
const _workspacesSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("systems.gmstn.api.chat.getWorkspaces#workspaces"),
  ),
...
declare module "@atcute/lexicons/ambient" {
  interface XRPCQueries {
    "systems.gmstn.api.chat.getWorkspaces": mainSchema;
  }
}
